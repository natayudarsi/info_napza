    ...
    showDialog(
        ...
        builder: (context) {
          return CustomDialog(
              title: 'Selesai',
              content:
                  'Anda telah menyelesaikan soal kuis dengan jumlah benar $totalTrue',
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: RaisedButton(
                      onPressed: () async {
                        if (_answer != null) {
                          finalAnswer.add(checkJawaban(_answer));
                          if (_indexSoalKe == 9) {
                            for(var answer in finalAnswer){
                              if(answer == 'Benar'){
                                totalTrue++;
                              }
                            }
                            print('ini answer $finalAnswer ini toal benar $totalTrue');
                            _showSelesai();
                          } else {
                            _showPenjelasan();
                            // setState(() {
