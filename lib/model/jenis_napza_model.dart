String ekstasy = 'Ekstasy Dikenal dengan nama : Inex, I, Kancing Drug, Yuppie Drug, Essence, Clarity, Butterfly ,Black Heart, dll.\nBentuk\t: Berupa table dan kapsul\nWarna\t: bermacam-macam\nPenggunaan\t: ditelan\nEfek :';
    
List efekEkstasy = ['Timbul rasa gembira secara berlebihan. Banyak orang mengkonsumsi ekstasy untuk tujuan bersenang-senang. Ekstasy banyak digunakan oleh anak-anak muda agar dapat berpesta di diskotik sepanjang malam. Karena saking gembiranya kadang-kadang sampai lepas kendali sehingga tidak malu-malu melakukan pesta seks.',
                    'Merasa cemas',
...
String cocain = 'Cocain Berasal dari tanaman yang banyak dijumpai di Columbia di Amerika Latin.\nBentuk\t: berupa bubuk, daun coca , buah coca , cocain kistal.\nWarna\t: -Cairan berwarna putih/tidak berwarna\n -Kristal berwarna putih\n -Tablet berwarna putih\n -Bubuk/serbuk seperti tepung\nPenggunaan\t: Dengan cara menghirup melalui hidung dengan menggunakan alat penyedot (sedotan) atau dapat juga dibakar bersama-sama dengan tembakau (rokok), ditelan bersama minuman, atau disuntikan pada pembuluh darah.\nEfek\t: ';

List efekCocain =['Tidak bergairah bekerja', 
    'Tidak bisa tidur',
    'Halusinasi', 
    'Tidak nafsu makan',
...
String morfin= 'Morfin dan Heroin Nama lain putaw, smack, junk, horse, H, PT, Etep, Bedak Putih\nBentuk\t: Berupa Serbuk\nWarna\t: Putih, abu-abu, kecoklatan hingga coklat tua\nPenggunaan\t: Dengan cara menghirup asapnya setelah bubuk heroin dibakar diatas kertas timah pembungkus rokok (sniffing­) atau dengan menyuntikkannya langsung ke pembuluh darah setelah heroin dilarutkan dalam air.\nEfek\t:';

List efekMorfin = ['Menimbulkan rasa mengantuk, lesu, penampilan “dungu” jalan mengambang.',
...
String obatPenenang = 'Obat penenang (obat tidur, pil koplo, BK, Nipam, Valium, Lexotan dan lain-lain)\nBentuk\t: Tablet, Kapsul, serbuk\nCara penggunaan\t: ditelan secara langsung\nEfek\t :';
    
List efekObatPenenang = ['Bicara jadi pelo, memperlambat Respons fisik, mental dan emosi. Dalam dosis tinggi akan membuat pengguna tidur, kemudian akan menimbulkan perasaan cemas, sensitive dan marah.',
    'Penggunaan campuran dengan alkohol dapat berakibat kematian', 
    'Gejala putus zat berakibat halusinasi buruk, bingung'];

String shabu = 'Shabu Dikenal dengan nama : Kristal, Ubas, SS, Mecin.\nBentuk\t: Berupa Kristal\nWarna\t: Putih\nPenggunaan\t: dibakar dengan menggunakan alluminium foil dan asapnya dihirup melalui hidung. Dibakar dengan menggunakan botol kaca khusus (bong) dan disuntikkan.\nEfek\t: ';
    
List efekShabu = ['Badannya merasa lebih kuat dan energik (meningkatkan stamina)',
    'Tidak mau diam (hiperaktif)',
    'Rasa percaya dan meningkat',
...
String ganja = 'Dikenal dengan nama : Cannabis, Mariyuana, Hasish, Gelek, Budha Stick, Cimeng, Grass, Rumput, Sayur.\nBentuk\t: berupa tanaman yang dikeringkan. Daun ganja bentuknya memanjang pinggirnya begerigi, ujungnya lancip, urat daun memanjang ditengah pangkal hingga ujung bila diraba bagian muka halus dan bagian belakang agak kasar.Jumlah helai daun ganja selalu ganjil yaitu 5, 7, atau 9 helai.\nWarna\t: Ganja hijau tua segar dan berubah coklat bila sudah lama dibiarkan karena kena udara dan panas.\nPenggunaan\t: Dihisap dari gulungan menyerupai rokok atau dapat juga dihisap dengan menggunakan pipa rokok.';

List efekGanja = ['Denyut jantung semakin cepat, temperature badan menurun, mata merah.', 
    'Nafsu makan bertambah.',
    'Santai, tenang dan melayang-layang .',
    'Fikiran selalu rindu pada ganja.',
    'Daya tahan menghadapi problema jadi lemah.',
    'Malas, apatis.',
    'Tidak perduli dan kehilangan semangat untuk belajar maupun bekerja.',
    'Perepsi waktu dan pertimbangan intelektual maupun moral terganggu.'];
...
List efekAmfetamin = ['Mulut kering.',
    'Mual dan muntah.',
    'Diare.',
    'Sembelit.',
    'Kram perut.',
...
String anggurKolosom = 'Anggur kolesom adalah minuman fermentasi yang terbuat dari perasan buah anggur.';

List efekAnggurKolosom = ['Kerusakan otak.',
    'Penyakit jantung.',
    'Kanker.',
    'Masalah paru.', 
    'Gangguan hati.',
...
String clobazam = 'Clobazam adalah obat golongan antikonvulsan yang digunakan untuk mengatasi epilepsi dan kejang. Penggunaan obat ini biasanya dikombinasi dengan obat lain untuk penderita epilepsi. Clobazam dapat mengontrol kejang dengan menyeimbangkan aliran listrik yang ada di dalam otak. Obat ini juga dapat digunakan untuk melemaskan otot.';

List efekClobazam = ['Mengantuk.',
    'Demam.',
...
String phenorbabital = 'Phenobarbital adalah obat untuk mengontrol dan meredakan kejang, yang salah satunya adalah akibat epilepsi. Phenobarbital atau fenobarbital bekerja dengan cara mengendalikan aktivitas listrik yang abnormal di sistem saraf dan otak selama terjadinya kejang. Selain sebagai antikejang, phenobarbital juga bisa digunakan menjadi obat penenang, sehingga terkadang digunakan dalam penanganan insomnia atau susah tidur. Namun, perlu diingat jika digunakan dalam penangan insomnia, obat ini tidak boleh digunakan dalam jangka panjang. ';

List efekPhenorbabital = ['Pusing.',
    'Kantuk.',
    'Sakit kepala.',
    'Mual.',
    'Muntah.',
